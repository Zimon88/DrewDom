...
public class RotatedLabel extends JLabel {
   ...
   */
  public RotatedLabel.Direction getDirection() {
    return direction;
  }
   ...
   *          The new direction.
   */
  public void setDirection(RotatedLabel.Direction direction) {
  ...
  public static void main(String[] args) {
    ...
    RotatedLabel r2 = new RotatedLabel("AAAAAAAAAAAAAAAAAAAAAA");
    RotatedLabel r3 = new RotatedLabel("436545yfgh w54yhs q65   q 3tr");
    rl.setBackground(Color.ORANGE);
    rl.setOpaque(true);
    rl.setDirection(RotatedLabel.Direction.VERTICAL_DOWN);
    r2.setDirection(Direction.VERTICAL_UP);
    r3.setDirection(Direction.HORIZONTAL);
    f.add(rl);
    f.add(r2);
    f.add(r3);
